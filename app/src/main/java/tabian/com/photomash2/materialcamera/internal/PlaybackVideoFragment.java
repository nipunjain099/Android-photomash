...
import tabian.com.photomash2.easyvideoplayer.EasyVideoCallback;
import tabian.com.photomash2.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(tabian.com.photomash2.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(tabian.com.photomash2.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(tabian.com.photomash2.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
